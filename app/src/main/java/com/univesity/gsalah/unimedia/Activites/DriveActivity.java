...
public abstract class DriveActivity extends AppCompatActivity {
    ...
    protected Task<DriveId> pickTextFile() {
        ...
        mimes.add("text/plain");mimes.add("pdf");mimes.add("text/html");mimes.add("doc");
        mimes.add("docx");mimes.add("ppt");mimes.add("pptx");mimes.add("jpg");mimes.add("png");mimes.add("xlsx");
        mimes.add("xls");
        OpenFileActivityOptions openOptions =
                new OpenFileActivityOptions.Builder()
                        //.setMimeType(mimes)
                        //.setSelectionFilter(Filters.eq(SearchableField.MIME_TYPE, "file"))
